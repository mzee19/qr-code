...
@section('sub-title', $action.' Shape')
@section('content')
<div class="main-content">
    <div class="content-heading clearfix">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{url('admin/shapes')}}"><i class="fa fa-tags"></i> Shapes</a></li>
            <li>{{$action}}</li>
        </ul>
    </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{$action}} Shape</h3>
                    </div>
                    <div class="panel-body">
                        @include('admin.messages')
                        <form id="shapes-form" class="form-horizontal label-left" action="{{url('admin/shapes')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" maxlength="100" class="form-control" required=""
                                        value="{{ ($action == 'Add') ? old('name') : $model->name}}" {{ ($action == 'Add') ? "" : "readonly"}}>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div style="width: 100px; height: auto">
                                        <img src="{{checkImage(asset('storage/shapes/' . $model->image),'placeholder.png',$model->image)}}"
                            ...
                            <div class="form-group" style="display: none;">
                                ...
                                <div class="col-sm-9">
                                    @php $type = ($action == 'Add') ? 1 : $model->type @endphp
                                    <label class="fancy-radio">
                                        <input name="type" value="1" type="radio" {{ ($type == 1) ? 'checked' : '' }}  >
                                        <span><i></i>Body Shape</span>
                                    </label>
                                    <label class="fancy-radio">
                                        <input name="type" value="2" type="radio" {{ ($type == 2) ? 'checked' : '' }} >
                                        <span><i></i>Eye Frame Shape</span>
                                    </label>
                                    <label class="fancy-radio">
                                        <input name="type" value="3" type="radio" {{ ($type == 3) ? 'checked' : '' }}>
                                        <span><i></i>Eye Ball Shape</span>
                                    </label>
                                </div>
                            </div>

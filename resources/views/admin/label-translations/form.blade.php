...
@section('title', 'Label Translations')
@section('content')
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/label-translations')}}"><i class="fa fa-language"></i> Label Translations</a></li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Label Translations</h3>
					</div>
					<div class="panel-body">
						@include('admin.messages')
						<form id="label-translations-form" class="form-horizontal label-left"
							action="{{url('admin/label-translations')}}" enctype="multipart/form-data" method="POST">
							@csrf
...
<script>
	$(function(){
        $('#label-translations-form').validate({
            errorElement: 'div',

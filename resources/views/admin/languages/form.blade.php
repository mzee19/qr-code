			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form id="languages-form" class="form-horizontal label-left" action="{{url('admin/languages')}}"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="name" maxlength="100" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('name') : $language->name}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="code" maxlength="10" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('code') : $language->code}}">
								</div>
							</div>
